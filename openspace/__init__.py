...
if _TYPE_CHECKING:
    ...
    from openspace.claude_artifacts import ClaudeArtifactManager as ClaudeArtifactManager
    from openspace.lifecycle import LifecycleManager as LifecycleManager
...
_attr_to_module: _Dict[str, str] = {
    ...
    "ClaudeArtifactManager": "openspace.claude_artifacts",
    "LifecycleManager": "openspace.lifecycle",
